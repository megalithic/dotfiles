...
- home/workbookpro.nix — per-model overrides: Qwen is_pinned=true; gemma4-8bit is_pinned=true max_context_window=65536 (different quant than megabookpro)
...
- workbookpro (64GB): Qwen3.6-35B-A3B-4bit (19GB, ~117 tok/s) + gemma-4-26b-a4b-it-8bit (26GB, ~75 tok/s)
...
2. ~/.omlx/model_settings.json contains gemma-4-26b-a4b-it-4bit (or -8bit on workbookpro) with model_alias=gemma4
3. On megabookpro: Qwen3.6 has is_pinned=false, ttl_seconds=1800, max_context_window=32768
4. On workbookpro: Qwen3.6 has is_pinned=true; gemma-4-26b-a4b-it-8bit has is_pinned=true, max_context_window=65536
...
omlx provider (models.json): qwen3.6, deepseek14b, gemma4 — for workbookpro
