...
- Find all _\_TASK.md / _\_PLAN.md in the plans dir (~/.local/share/pi/plans/$(basename $PWD)/)
...
1. /task with no args, /plan with no args, /tickets with no args — when orphan-scan returns 0 — emit a message instructing the agent to scan the plans dir for all _\_TASK.md / _\_PLAN.md, sort by mtime, present top 3 with phase summary
