...
5. Final integrated result is verifiable with `just validate home` plus tmux+nvim manual smoke tests for primary pinvim link, parked flows, ephemeral flows, and shimmed Telegram/tell compatibility.
