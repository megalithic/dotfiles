...
- pi's MCP gateway prefixes tool names with 'tidewave\_' (e.g. tidewave_project_eval) but the actual Tidewave MCP server exposes them without prefix (e.g. project_eval)
