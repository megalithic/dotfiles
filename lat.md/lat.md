...
- [[architecture]] — flake topology, `lib.mega` and builders, custom package overlay, out-of-store config symlinks, rebuilds, repo dev environment (mise/hk), secrets, linting, and agent policy.
