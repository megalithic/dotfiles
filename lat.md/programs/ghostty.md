...
The module enables `programs.ghostty`, installs `pkgs.ghostty-bin`, injects fish shell integration, and sets `clearDefaultKeybinds = false`, but it does not put behavior settings in `programs.ghostty.settings`.
