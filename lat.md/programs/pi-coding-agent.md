...
The former Home Manager module (`nix/pkgs/common/programs/pi-coding-agent/`) and vendored `pi-acp` adapter are removed. Current Home Manager generations claim no Pi files.
