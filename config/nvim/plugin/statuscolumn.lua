...
function mega.ui.statuscolumn.render()
...
opt.statuscolumn = "%{%v:lua.mega.ui.statuscolumn.render()%}"

mega.augroup("StatusCol", {
  event = { "BufEnter", "FileType" },
  command = function(args)
    local buf = args.buf
    if vim.bo[buf].ft == false or vim.bo[buf].fname == false then vim.opt_local.statuscolumn = "" end
  end,
})
