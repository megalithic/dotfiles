...
map({ "i", "n" }, "<C-Right>", ":tabn<CR>", { desc = "next tab" })
map({ "i", "n" }, "<C-Left>", ":tabp<CR>", { desc = "prev tab" })
map({ "i", "n" }, "<C-Up>", ":+tabmove<CR>", { desc = "move tab right" })
map({ "i", "n" }, "<C-Down>", ":-tabmove<CR>", { desc = "move tab left" })
