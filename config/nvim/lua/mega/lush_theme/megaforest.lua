...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    -- sym("@markup.link.label")({ link = "Tag" }),
    -- sym("@string.special.symbol")({ link = "@variable.member" }),
    -- sym("@tag")({ Purple }),
    -- sym("@tag.attribute")({ link = "@variable.member" }),
    -- sym("@tag.delimiter")({ link = "Delimiter" }),
    -- sym("@none")({ Fg }),
    -- sym("@markup.strong")({ fg = C.fg, fmt = "bold" }),
    -- sym("@markup.italic")({ fg = C.fg, fmt = "italic" }),
    -- sym("@markup.underline")({ fg = C.fg, fmt = "underline" }),
    -- sym("@markup.strikethrough")({ fg = C.fg, fmt = "strikethrough" }),
    -- sym("@markup.heading")({ fg = C.orange, fmt = "bold" }),
    -- sym("@markup.heading.1")({ fg = C.red, fmt = "bold" }),
    -- sym("@markup.heading.1.marker")({ link = "@markup.heading" }),
    -- sym("@markup.heading.2")({ fg = C.yellow, fmt = "bold" }),
    -- sym("@markup.heading.2.marker")({ link = "@markup.heading" }),
    -- sym("@markup.heading.3")({ fg = C.green, fmt = "bold" }),
    -- sym("@markup.heading.3.marker")({ link = "@markup.heading" }),
    -- sym("@markup.heading.4")({ fg = C.cyan, fmt = "bold" }),
    -- sym("@markup.heading.4.marker")({ link = "@markup.heading" }),
    -- sym("@markup.heading.5")({ fg = C.blue, fmt = "bold" }),
    -- sym("@markup.heading.5.marker")({ link = "@markup.heading" }),
    -- sym("@markup.heading.6")({ fg = C.purple, fmt = "bold" }),
    -- sym("@markup.heading.6.marker")({ link = "@markup.heading" }),
    -- sym("@markup.raw")({ Green }),
    -- sym("@markup.raw.delimiter")({ LightGrey }),
    -- sym("@string.special.url")({ fg = C.cyan, fmt = "underline,italic" }),
    -- sym("@markup.link.url")({ fg = C.cyan, fmt = "underline,italic" }),
    -- sym("@markup.list.checked")({ fg = C.yellow, fmt = "bold" }),
    -- sym("@markup.list.unchecked")({ fg = C.light_grey, fmt = "bold" }),
    ...
    -- sym("@markup.math")({ fg = light_blue }),
    -- sym("@markup.link")({ link = "Tag" }),
    -- sym("@markup.environment")({ fg = C.cyan, fmt = "bold" }),
    -- sym("@markup.environment.name")({ link = "Type" }),
