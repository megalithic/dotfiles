...
-----------------------------------------------------------------------------//
vim.cmd.abbrev([[fullfilment fulfillment]])
vim.cmd.abbrev([[fulfilment fulfillment]])
vim.cmd.abbrev([[fullment fulfillment]])
...
-- if U.executable("rg") then
--   vim.o.grepprg = [[rg --glob "!.git" --no-heading --vimgrep --follow $*]]
--   vim.opt.grepformat = vim.opt.grepformat ^ { "%f:%l:%c:%m,%f:%l:%m" }
-- elseif U.executable("ag") then
--   vim.o.grepprg = [[ag --nogroup --nocolor --vimgrep]]
--   vim.opt.grepformat = vim.opt.grepformat ^ { "%f:%l:%c:%m" }
-- end
