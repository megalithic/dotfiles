...
local M = {
  ...
  completion_exclusions = { "elixirls", "nextls", "" },
  formatter_exclusions = { "elixirls", "nextls", "" },
  definition_exclusions = { "elixirls", "nextls", "" },
  references_exclusions = { "elixirls", "nextls", "" },
  diagnostic_exclusions = { "elixirls", "nextls", "" },
  max_diagnostic_exclusions = { "elixirls", "nextls", "" },
