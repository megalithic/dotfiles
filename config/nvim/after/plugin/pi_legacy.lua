-- after/plugin/pi_legacy.lua
-- Legacy Pi Coding Agent integrations
--
...
function connection_connect()
  ...
  pipe:connect(socket_path, function(err)
    ...
    vim.schedule(function()
      start_ping_timer()
      flush_queue()
      -- Push current editor state immediately so pinvim_legacy.ts footer updates
...
local function build_editor_state()
  ...
  -- during active extend. pinvim_legacy.ts renders `selectionRange` as
