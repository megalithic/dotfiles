...
local root_names = { ".jj", ".git", "Makefile", "Justfile", ".envrc", "devspace.yaml", "go.mod", "go.sum", ".claude" }
...
Augroup("FindProjectRoot", { event = "BufEnter", command = set_root })
