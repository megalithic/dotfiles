...
function M.clear_last_move() M.last_move = nil end
...
function M.repeat_last_move_next() return M.repeat_last_move({ forward = true }) end

function M.repeat_last_move_previous() return M.repeat_last_move({ forward = false }) end
