...
def main() -> None:
    ...
    if tmux:
        weechat.hook_command(SCRIPT_NAME, SCRIPT_DESC, "", "", "", "fzf_tmux_command_cb", "")
    elif kitty:
        weechat.hook_command(SCRIPT_NAME, SCRIPT_DESC, "", "", "", "fzf_kitty_command_cb", "")
    else:
        print_error("Error: fzf.py currently only supports being run inside tmux or kitty")
