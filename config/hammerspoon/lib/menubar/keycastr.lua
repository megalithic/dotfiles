...
obj.mods_event_tap = nil
obj.keys_event_tap = nil
...
function obj:init()
  ...
  obj.mods_event_tap = hs.eventtap.new({
    event_types.flagsChanged,
  }, handle_mod_event)
  obj.keys_event_tap = hs.eventtap.new({
    event_types.keyDown,
    event_types.keyUp,
  }, handle_key_event)
...
function obj:start()
  obj.mods_event_tap:start()
  obj.keys_event_tap:start()
