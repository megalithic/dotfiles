...
| ----------- | ----------------------------- | ------------------ | ---------------------------------------------------------------------------------- |
| **Global**  | `~/.pi/agent/mcp.json`        | Mise `[dotfiles]`  | Edit `~/.dotfiles/config/pi-coding-agent/agent/mcp.json`; symlink is live     |
...
1. Edit `~/.dotfiles/config/pi-coding-agent/agent/mcp.json`
...
1. Read global config: `~/.dotfiles/config/pi-coding-agent/agent/mcp.json`
