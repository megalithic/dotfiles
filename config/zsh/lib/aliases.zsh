...
# TODO: pull ignored folders from `config/fd/ignore`:
alias tree="tree -I 'dotbot|node_modules|cache|test_*'"
...
alias evs="nvim $DOTS/config/nvim/lua/mega/plugins/lsp/servers.lua"
alias evl="nvim $DOTS/config/nvim/lua/mega/plugins/lsp/init.lua"
