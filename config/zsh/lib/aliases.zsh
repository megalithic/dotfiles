...
alias evv="nvim $DOTS/config/nvim/minvimrc.vim"
...
alias evm="nvim $DOTS/config/nvim/lua/config/mappings.lua"
alias eva="nvim $DOTS/config/nvim/lua/config/autocmds.lua"
alias evl="nvim $DOTS/config/nvim/after/plugin/lsp/init.lua"
alias evs="nvim $DOTS/config/nvim/after/plugin/lsp/servers.lua"
