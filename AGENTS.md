...
4. GUI-independent fallback: plug in the YubiKey, then `export OP_SERVICE_ACCOUNT_TOKEN="$(fnox --profile bootstrap get OP_SERVICE_ACCOUNT_TOKEN)"`. First-time hardware setup: `mise run setup:yubikey`.
