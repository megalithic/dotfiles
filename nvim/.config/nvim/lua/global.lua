...
M.dirs = {
	-- org = vim.fn.expand("$HOME/Library/Mobile Documents/com~apple~CloudDocs/org"),
	org = vim.fn.expand("$HOME/Documents/_org"),
	dots = vim.fn.expand("$HOME/.dotfiles"),
	zettel = vim.fn.expand("$HOME/Documents/_notes"),
}
