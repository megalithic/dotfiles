...
local on_attach = function(client, bufnr)
  ...
  if client.resolved_capabilities.hover then
    utils.bmap("n", "<CR>", "<cmd>lua vim.lsp.buf.hover()<CR>")
  end
  ...
  utils.bmap("n", "<Leader>lge", "<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>")
  ...
  function()
    ...
    -- "autocmd CursorHold <buffer> lua require('lc.diagnostics').show_line_diagnostics()"
...
vim.fn.sign_define("LspDiagnosticsSignInformation", {text = sign_information, numhl = "LspDiagnosticsDefaultInformation"})
