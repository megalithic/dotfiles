...
" ## Syntax
  ...
  Plug 'elixir-editors/vim-elixir', { 'for': ['exs', 'ex', 'eex', 'elixir', 'eelixir'] }
...
" TODO: investigate this completion setup: https://github.com/docwhat/dotfiles/blob/master/tag-neovim/config/nvim/plugin/plug-coc.vim#L22
