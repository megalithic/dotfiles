...
do
  ...
  local plugins_loaded, plugins = pcall(require, "mega.plugins")
  if plugins_loaded then
    plugins.activate()
  else
    mega.inspect("", plugins, 4)
  end

  -- local statusline_loaded, statusline = pcall(require, "mega.statusline")
  -- if statusline_loaded then
  --   statusline.load()
  -- else
  --   mega.inspect("", statusline, 4)
  -- end
end
