...
│   ├── services.nix     # User-level launchd services
...
- `llama-cpp` — llama.cpp local inference server (opt-in via `programs.llamaCppLocal.enable`)
- `espanso` — text expansion launcher
