...
in {
  programs.aerc = {
    ...
    # Stylesets (themes)
    stylesets.everforest = builtins.readFile "${inputs.self}/home/common/programs/aerc/stylesets/everforest";
    stylesets.megaforest = builtins.readFile "${inputs.self}/home/common/programs/aerc/stylesets/megaforest";
