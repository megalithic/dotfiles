...
#
# MCP servers are defined in ./mcp.nix and shared with OpenCode via _module.args
{
  config,
  pkgs,
  lib,
    ...
    context = ''
      ...
      **CRITICAL**: This Mac is configured almost entirely through Nix (nix-darwin + home-manager) managed in the dotfiles repository (`~/.dotfiles`).
      ...
      - Common locations:
        ...
        - AI tools config -> `~/.dotfiles/home/common/programs/{claude-code,opencode,ollama,pi-coding-agent}/`
