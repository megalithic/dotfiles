...
**Script location:** `~/.dotfiles/home/common/programs/pi-coding-agent/skills/handoff/scripts/`
...
~/.dotfiles/home/common/programs/pi-coding-agent/skills/handoff/scripts/handoff.sh --file /tmp/handoff-content.md --title "Brief title"
...
~/.dotfiles/home/common/programs/pi-coding-agent/skills/handoff/scripts/pickup.sh

# Or specify a session
~/.dotfiles/home/common/programs/pi-coding-agent/skills/handoff/scripts/pickup.sh mega
~/.dotfiles/home/common/programs/pi-coding-agent/skills/handoff/scripts/pickup.sh rx
```
...
```bash
~/.dotfiles/home/common/programs/pi-coding-agent/skills/handoff/scripts/pickup.sh --list
~/.dotfiles/home/common/programs/pi-coding-agent/skills/handoff/scripts/pickup.sh --list mega
```
