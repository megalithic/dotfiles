...
if [ -n "$(command -v fzf)" ]; then
  ...
  "
	...
	if (command -v fd &>/dev/null); then
		...
		export FZF_DEFAULT_COMMAND='fdfind --type f -follow --hidden --color=always --exclude .git --ignore-file ~/.gitignore_global --ignore-file .gitignore'
		export FZF_CTRL_T_COMMAND='fdfind --type f --follow --hidden --color=always --exclude .git --ignore-file ~/.gitignore_global --ignore-file .gitignore'
