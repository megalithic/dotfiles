...
# (Apple Silicon).
#
# Unlike pkgs/helium-browser.nix (imput's public DMG + local Widevine
# injection + helper re-signing), these releases are built in CI from
# megalithic/helium-macos with Widevine already injected, then Developer ID
# signed (Seth Messer, 3ZJ3F5RFBZ) and notarized. So this package does no
# signing and no Widevine work — it only unpacks the DMG.
#
