...
-- Window management: golden ratio resize + safe window close.
--
-- Features:
-- 1. Golden ratio auto-resize for focused windows (resize_ignore_*)
-- 2. Safe window close: prevents E444, handles edge cases
--
-- Separation of concerns:
-- - resize_ignore: windows that shouldn't get golden ratio (help, oil, qf, etc.)
-- - quitter: buffers skipped when finding an alternate (sidebars, terminals, AI panels)
